...
export const CommonSubTitle = styled.h2`
  ...
  margin: ${(props) => props.margin || `100px 0 0`};
  display: flex;
  align-items: center;
...
export const Beginner = styled(Wrapper)`
  width: auto;
  position: absolute;
  top: 5px;
  left: 5px;
  padding: 5px 10px;
  border-radius: 20px;
  background: ${(props) => props.theme.green_C};
  color: #38ada9;
  box-shadow: 0 3px 3px ${(props) => props.theme.lightGrey_C};
  font-size: 13px;
`;

export const Middle = styled(Wrapper)`
  width: auto;
  position: absolute;
  top: 5px;
  left: 5px;
  padding: 5px 10px;
  border-radius: 20px;
  background: ${(props) => props.theme.yellow_C};
  color: #fa983a;
  box-shadow: 0 3px 3px ${(props) => props.theme.lightGrey_C};
  font-size: 13px;
`;

export const Advanced = styled(Wrapper)`
  width: auto;
  position: absolute;
  top: 5px;
  left: 5px;
  padding: 5px 10px;
  border-radius: 20px;
  background: ${(props) => props.theme.blue_C};
  color: #1e3799;
  box-shadow: 0 3px 3px ${(props) => props.theme.lightGrey_C};
  font-size: 13px;
`;
