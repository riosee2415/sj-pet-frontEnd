...
export const CommonButton = styled.button`
  ...
  color: #fff;
  ${(props) =>
    !props.kindOf && `background : ${props.theme.adminBasicTheme_C};`}
  ${(props) =>
  ...
  &:hover {
    ...
    box-shadow: ${(props) => props.theme.boxShadow};
    ${(props) =>
      !props.kindOf && `border :1px solid ${props.theme.adminBasicTheme_C};`}
    ${(props) =>
      props.kindOf === `create` &&
...
export const StatusButton = styled.button`
  ...
  background-color: ${(props) =>
    props.status ? props.theme.update_B_C : props.theme.lightGrey_C};
  &:hover {
    background-color: ${(props) => props.theme.white_C};
    color: ${(props) => props.theme.subBlack_C};
...
export const SideMenu = styled.div`
  ...
  line-height: 30px;
  color: ${(props) =>
    props.isActive ? props.theme.adminBasicTheme_C : `#fff`};
  font-weight: 600;
  margin-bottom: 5px;
  padding: 5px;
  cursor: pointer;
