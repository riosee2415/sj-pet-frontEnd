...
const tabs = ["BANNER 1", "BANNER 2", "BANNER 3", "BANNER 4", "BANNER 5"];
        ...
        <Wrapper minWidth={`1344px`} al={`flex-start`} ju={`flex-start`}>
          <Wrapper>
            <GuideBox margin={`10px 0px`} padding={`10px 0px`}>
              <GuideContent padding={`0px 10px`} margin={`5px 0px`}>
                이미지 사이즈(비율)은 가로 400px, 세로 650px을 권장합니다.
              </GuideContent>
              <GuideContent padding={`0px 10px`} margin={`5px 0px`}>
          ...
          <Wrapper>
            <Image
              ...
              src={
                mobileMainBannerDatum &&
                mobileMainBannerDatum[currentTab].imagePath
              }
            />
